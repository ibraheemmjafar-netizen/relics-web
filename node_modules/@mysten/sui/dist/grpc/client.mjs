...
import { GrpcWebFetchTransport } from "./transport.mjs";
...
var SuiGrpcClient = class extends BaseClient {
	...
	constructor(options) {
		...
		const { network: _network, mvr: _mvr, abort: _abort, transport: providedTransport, ...transportOptions } = options;
