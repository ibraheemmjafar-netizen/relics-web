...
let TransactionExpiration_TransactionExpirationKind = /* @__PURE__ */ function(TransactionExpiration_TransactionExpirationKind$1) {
	...
	*/
	TransactionExpiration_TransactionExpirationKind$1[TransactionExpiration_TransactionExpirationKind$1["VALIDITY"] = 4] = "VALIDITY";
...
var AllowedProposers$Type = class extends MessageType {
	constructor() {
...
*/
const AllowedProposers = new AllowedProposers$Type();
