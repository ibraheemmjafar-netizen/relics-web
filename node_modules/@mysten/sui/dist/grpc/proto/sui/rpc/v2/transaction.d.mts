...
declare class AllowedProposers$Type extends MessageType<AllowedProposers> {
  constructor();
}
/**
 * @generated MessageType for protobuf message sui.rpc.v2.AllowedProposers
 */
declare const AllowedProposers: AllowedProposers$Type;
