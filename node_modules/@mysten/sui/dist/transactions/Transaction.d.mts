...
declare class Transaction {
  ...
  getData(): {
    ...
    expiration?: _mysten_bcs1241.EnumOutputShapeWithKeys<{
      None: true;
      Epoch: string | number;
      ValidDuring: {
    ...
    inputs: _mysten_bcs1241.EnumOutputShapeWithKeys<{
      Object: _mysten_bcs1241.EnumOutputShapeWithKeys<{
        ImmOrOwnedObject: {
          objectId: string;
          version: string | number;
          digest: string;
      ...
      FundsWithdrawal: {
        ...
        withdrawFrom: _mysten_bcs1241.EnumOutputShapeWithKeys<{
          Sender: true;
          Sponsor: true;
          SenderAllowance: {
            funder: string;
    ...
    commands: _mysten_bcs1241.EnumOutputShapeWithKeys<{
      MoveCall: {
        package: string;
        module: string;
        function: string;
  ...
  getDigest(options?: Pick<BuildTransactionOptions, 'client' | 'assumeSufficientAddressBalances'>): Promise<string>;
